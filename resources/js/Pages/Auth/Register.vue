                                    ...
                                    <form @submit.prevent="submit" class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input :type="togglePassword ? 'text' : 'password'" class="form-control pe-5 password-input"
                                                ...
                                                <BButton variant="link"
                                                    ...
                                                    type="button" @click="togglePassword = !togglePassword"><i class="ri-eye-fill align-middle"></i></BButton>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input :type="togglePassword_conf ? 'text' : 'password'" class="form-control pe-5 password-input"
                                                ...
                                                <BButton variant="link"
                                                    class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                    type="button" @click="togglePassword_conf = !togglePassword_conf"><i class="ri-eye-fill align-middle"></i></BButton>
                                        ...
                                        <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature"
                                            ...
                                            <label class="form-check-label mb-0 fs-12 text-muted fst-italic"
                                                for="auth-remember-check">
                                                I agree to the <BLink target="_blank" :href="route('terms.show')" class="">Terms
                                                    of Service</BLink> and <BLink target="_blank" :href="route('policy.show')"
                                                    class="">Privacy Policy</BLink>
                                            </label>

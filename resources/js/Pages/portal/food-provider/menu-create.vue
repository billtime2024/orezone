...
export default {
    ...
    methods: {
        submit() {
            this.form.post('/portal/food-provider/menu', {
                preserveScroll: true,
            });
        },
        toggleDay(day) {
...
<template>
    <Head title="Add Menu Item - orezone Provider" />
    <PortalLayout>
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h4 class="fw-bold text-dark mb-1">Add Menu Item</h4>
                <p class="text-muted mb-0">Add a new dish to your menu</p>
            </div>
        </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input v-model="form.name" type="text" class="form-control" placeholder="e.g., Paneer Butter Masala"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea v-model="form.description" class="form-control" rows="3"
                                    placeholder="Describe the dish, ingredients, taste..."></textarea>
                            </div>
                            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-lg text-white" style="background-color: #2E7D5B;"
                            ...
                            {{ form.processing ? 'Saving...' : 'Add Menu Item' }}
                        </button>
                    </div>
                </div>
            </div>
